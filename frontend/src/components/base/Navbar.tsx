        ...
        <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5 ">
            <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                <a href="/" className="flex items-center">
                    ...
                    <span className="self-center text-xl font-semibold whitespace-nowrap ">TODO app</span>
                </a>
                <button onClick={() => { updatePage(PageTypes.HOME) }}>TaskList</button>
                <button onClick={() => { updatePage(PageTypes.TASK_LIST) }}>EXAMPLE </button>
                ...
                <div className="flex items-center lg:order-2">
                    ...
                    <a href="#" className="text-black bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2  focus:outline-none">Get started</a>
